...
MLFLOW_TRACKING_URI = f"sqlite:///mlruns.db"
...
def get_current_model_parameters():
    ...
    '''
    for model_version in client.search_model_versions("name='responce-prediction-model'"):
...
if __name__ == '__main__':
    ...
    model_name= "response-prediction-model"
